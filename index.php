	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true">Product</a>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form method="post" id="user_form">
						...
						<!--tr>
      <td  class="purchaseDetailsItemName"></td>
      <td  class="purchaseDetailsQuantity"></td>
      <td  class="purchaseDetailsUnitPrice"></td>
...
$(document).ready(function() {
	...
	$(".addPurchase1").click(function() {
		...
		<td width="100px" class="product_name'+new_count+'">' + $("#purchaseDetailsItemName").val() + '</td>\n\
		<td width="100px" class="invoice_number'+new_count+'">' + $("#purchaseDetailsInvoiceNumber").val() + '</td>\n\
		<td width="100px" class="quantity'+new_count+'">' + $("#purchaseDetailsQuantity").val() + '</td>\n\
		<td width="100px" class="unit_price'+new_count+'">' + $("#purchaseDetailsUnitPrice").val() + '</td>\n\
		<td width="100px" class="total_price'+new_count+'">' + $("#purchaseDetailsTotal").val() + '</td>\n\
	...
	$("#insert").click(function() {
		...
		for ( var i = 1; i <= lastRowId; i++) {
			product_name.push($("#"+i+" .product_name"+i).html()); /*pushing all the names listed in the table*/
			invoice_number.push($("#"+i+" .invoice_number"+i).html()); /*pushing all the emails listed in the table*/
			quantity.push($("#"+i+" .quantity"+i).html()); /*pushing all the emails listed in the table*/
			unit_price.push($("#"+i+" .unit_price"+i).html()); /*pushing all the emails listed in the table*/
			total_price.push($("#"+i+" .total_price"+i).html()); /*pushing all the emails listed in the table*/
		}
		var sendProductName = JSON.stringify(product_name); 
		var sendInvoice_Number = JSON.stringify(invoice_number);
		var sendQuantity = JSON.stringify(quantity);
		var sendUnit_Price = JSON.stringify(unit_price);
		var sendTotal_Price = JSON.stringify(total_price);
		$.ajax({
			url: "save.php",
			type: "post",
