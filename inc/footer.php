    <!-- Footer -->
    <footer class="footer bg-dark" style="background: linear-gradient(45deg, #0f0f10de, #556f92e3);">
      <div class="container">
        <p class="m-0 text-center text-white">Project by - Shubham under Cyberton Software's in <?php echo date('Y'); ?></p>
      </div>
    </footer>
