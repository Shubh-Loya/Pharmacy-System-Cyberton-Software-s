<?php
	...
	if(isset($_POST['purchaseDetailsBatchNumber'])){
		$output = '';
		...
		$stmt->execute(['itemName' => $purchaseDetailsItemName]);
		...
		if($stmt->rowCount() > 0){
			...
			$output = '<ul class="list-unstyled suggestionsList" id="purchaseDetailsBatchNumberSuggestionsList">';
